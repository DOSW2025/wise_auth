...
describe('GestionUsuariosService', () => {
  ...
  describe('changeRole', () => {
    ...
    it('should change user role successfully', async () => {
      ...
      expect(prismaService.rol.findUnique).toHaveBeenCalledWith({
    ...
    it('should throw NotFoundException when role does not exist', async () => {
      ...
      await expect(service.changeRole(userId, changeRoleDto)).rejects.toThrow(
    ...
    it('should verify role exists before updating user', async () => {
      ...
      expect(prismaService.rol.findUnique).toHaveBeenCalledBefore(
  ...
  describe('changeStatus', () => {
    ...
    it('should change user status successfully', async () => {
      ...
      expect(prismaService.estadoUsuario.findUnique).toHaveBeenCalledWith({
    ...
    it('should throw NotFoundException when status does not exist', async () => {
      ...
      await expect(service.changeStatus(userId, changeStatusDto)).rejects.toThrow(
      ...
      await expect(service.changeStatus(userId, changeStatusDto)).rejects.toThrow(
        ...
        'Estado con id 999 no encontrado',
    ...
    it('should verify status exists before updating user', async () => {
      ...
      expect(prismaService.estadoUsuario.findUnique).toHaveBeenCalledBefore(
